...
class TestJobName(TestCase):
    ...
    def test_other_tags(self):
        self.assertEqual('foo_p42', JobName('foo').potl(42))
        ...
        self.assertEqual('foo_r4', JobName('foo').repeat(4))
        self.assertEqual('foo', JobName('foo').repeat(None))
        self.assertEqual('foo_t3', JobName('foo').trial(3))
        ...
        self.assertEqual('foo_cDAldil', JobName('foo').c_D03_anti_Al_to_Fe('Dilute'))

    def test_call(self):
        name = JobName('foo')
        self.assertEqual(
            'foo_p42_bcc_r4_t3_273K_P0_0_cDAl11_1',
            name(
                potl_index=42,
                bcc=True,
                repeat=4,
