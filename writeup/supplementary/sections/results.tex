...
In practice, we found that a threshold value of 11 of the 14 NN did a good job of this, and the interested reader can examine the \code{github} repository~\cite{github} for more detail.
