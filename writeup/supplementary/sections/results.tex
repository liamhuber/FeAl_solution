...
In this near-equilibium regime, we see that fully \emph{half} of the atoms participating in a \DOTHREE cluster are not preserved from snapshot to snapshot.
